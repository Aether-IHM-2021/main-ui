    ...
    <>
      ...
      >
        <CardPosts
          ...
          description={
            'Now, just imagine if we have at least one public library in each congressional district...'
          }
          starCount={34}
          topic={'proposal'}
          imageSrc={
            'https://lh3.googleusercontent.com/proxy/NMKVF0unzGF-SIG3jVoRSe9j0qosZYeGZVeDSeLX7SPswVzsQiSmLRTnAZAZFJfhGg4LRbeQ4pDdB9FIT03ZwAXtijPf7Ql382k0tM3noTVWdbIjZOzzlmip2YnUCyopGDcF'
          }
        />
        <CardPosts
          agreeCount={580}
          ...
          topic={'news'}
          imageSrc={
            'https://www.adb.org/sites/default/files/styles/content_media/public/content-media/6402-philippines-cleaning-pasig-river-feature-01.jpg?itok=SOhmA1xZ'
          }
        />
        <CardPosts
          agreeCount={580}
          ...
          topic={'concern'}
          imageSrc={
            'http://4.bp.blogspot.com/-hsqL4cku7NM/VD4fvqd0zeI/AAAAAAAAXOg/Q-uukYGHEII/s1600/DSCN1266.JPG'
          }
        />
      </div>
    </>
